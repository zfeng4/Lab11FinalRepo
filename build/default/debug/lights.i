...
void LED_init();
void LED_setColor(unsigned int red, unsigned int green, unsigned int blue, unsigned int white);
void UART_init();
...
void LED_setColor(unsigned int red, unsigned int green, unsigned int blue, unsigned int white){
    if(red < 256 && green < 256 && blue < 256 && white < 256){
        red = ((float)red / 2048) * (4000000 / (122 * 32));
        green = ((float)green / 2048) * (4000000 / (122 * 32));
        blue = ((float)blue / 2048) * (4000000 / (122 * 32));
        white = ((float)white / 2048) * (4000000 / (122 * 32));
    } else {
        red = ((float)255 / 2048) * (4000000 / (122 * 32));
        green = ((float)255 / 2048) * (4000000 / (122 * 32));
        blue = ((float)255 / 2048) * (4000000 / (122 * 32));
        white = ((float)255 / 2048) * (4000000 / (122 * 32));
    }
